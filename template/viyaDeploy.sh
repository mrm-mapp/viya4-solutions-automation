  ...
  do
    ...
    do
      ...
      then
        ...
        kustomization_insert "kustomization.yaml" "$modifier" "[{\"name\": \"${cirrus_solution}-parameters\", \"behavior\": \"merge\", \"envs\": [\"site-config/$cirrus_solution/configuration.env\"]}]" "block_append"
